...
<div class="important-box">
  ...
  <p>AIの説明は、いつも正しいとは限りません。本研修の解説や公式資料と照合し、自分で値を追って検証しましょう。「AIが言ったから正しい」ではなく、「自分でも同じ結果を確かめられたから正しい」と判断します。</p>
</div>
...
<ol class="toc-list">
  ...
  <li><a href="#chapter-6"><span>第6章　配列</span><b>61</b></a></li>
  <li><a href="#chapter-7"><span>第7章　トレースの技術</span><b>71</b></a></li>
  <li><a href="#chapter-8"><span>第8章　総合演習</span><b>80</b></a></li>
  <li><a href="#answers"><span>解答・解説</span><b>88</b></a></li>
  <li><a href="#roadmap"><span>研修後の学習ロードマップ</span><b>137</b></a></li>
</ol>
...
<div class="ai-box">
  <p class="ai-label">AIへの質問例｜考え方や疑問点を伝える</p>
  <p>問題5-Eについて質問です。「3000円以上で終了」させたいとき、whileの繰返し条件は「＜ 3000」で合っていますか？終了条件と継続条件の違いを教えてください。</p>
</div>
...
<div class="ai-box">
  <p class="ai-label">AIへの質問例｜考え方や疑問点を伝える</p>
  <p>問題6-Fについて質問です。同じ値が複数ある配列で「最初に見つかった位置」だけを残すために、条件式に「position ＝ 0」を入れる理由を教えてください。</p>
</div>
...
<div class="ai-box">
  <p class="ai-label">AIへの質問例｜考え方や疑問点を伝える</p>
  <p>問題7-Fについて質問です。配列で同じ値の連続を数えるとき、なぜ「A[i] ≠ A[i−1]」という条件式でグループの変わり目を判定できるのですか？</p>
</div>
...
> 自習中の参考書『○○』第○版、○ページの問○についてです。問題文とコードを添付します。まず入力条件と求める結果の認識が合っているか教えてください。私は○行目まで考えました。次の行で使う値が分からないので、答えではなく一つだけヒントをください。
...
<div class="prompt-card">
  ...
  答えを直接教えるのではなく、私がどこまで正しく考えられているかを教えてください。<br>
