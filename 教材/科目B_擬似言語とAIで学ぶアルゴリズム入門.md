...
<div class="ai-box">
  ...
  <p>問題4-Aについて質問です。2で割った余り（x mod 2）を使って偶数・奇数を判定したいのですが、条件式は「x mod 2 ＝ 0」で合っていますか？</p>
</div>
...
<div class="ai-box">
  <p class="ai-label">AIへの質問例｜考え方や疑問点を伝える</p>
  <p>問題4-Dについて質問です。「and」で複数の条件をつないだ場合、片方だけが成立しているときは真になりますか？真偽の判定の仕組みを教えてください。</p>
</div>
